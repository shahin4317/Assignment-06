...
const Footer = () => {
    return (
        <div className='bg-gray-900'>
            <div className='grid grid-cols-6 p-10 px-15 text-white mb-5'>
                <div className='space-y-5'>
                    <h2 className='text-3xl font-bold'>DigiTools</h2>
                    <p className='text-sm text-gray-400'>Premium digital tools for creators, <br /> professionals, and businesses.Work smarter with our suite of powerful tools.</p>
                </div>
                {/* 1 */}
                <div>
                ...
                {/* 2 */}
                <div className='space-y-3'>
                    <p className='text-xl font-semibold'>Link</p>
            ...
            <div className='text-sm text-gray-400 px-15 flex  gap-3 '>
                <div className=' mr-200 mb-10 gap-3'>
